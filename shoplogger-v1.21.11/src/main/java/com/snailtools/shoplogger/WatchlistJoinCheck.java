...
public final class WatchlistJoinCheck {
	...
	private static void reportMarketplace(MinecraftClient client, String world, List<WatchedItem> watched, List<MarketplaceListing> listings) {
	...
	private static void report(MinecraftClient client, String world, List<WatchedItem> watched, List<Listing> listings) {
